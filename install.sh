...
[[ "${resp}" = "S" || "${resp}" = "s" ]] && {
  ...
  wget https://github.com/Willifergamer/Whatsappbotwill/blob/main/watsapp.zip > /dev/null 2>&1
  ...
  unzip watsapp.zip > /dev/null 2>&1
  ...
  cd $HOME
  wget https://raw.githubusercontent.com/Willifergamer/Whatsappbotwill/main/botzap > /dev/null 2>&1
